...
export const CARD_HEIGH = 461;

export const SOUVENIR_PILE_X = 1276;
export const SPRINGS_PILE_X = 1543;
export const ENCOUNTER_PILE_X = 1811;
export const MEAL_PILE_X = 2076;
export const MEALSET_PILE_X = 2297;

export const PADDY_PILE_X = 2979;
export const MOUNTAIN_PILE_X = 3245;
export const SEA_PILE_X = 3513;
export const PILE_Y = 50;
export const PANO_PILE_Y = 700;
